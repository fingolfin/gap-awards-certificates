...
\centering
\includegraphics[height=1.1cm]{gaplogo.pdf}
\end{minipage}
\vspace{-8mm}
...
\tiny In honour of their significant contributions to the GAP system we hereby award the}

\smallskip

%\textcolor{red!30!black!90}{\textit{GAP excellence award}}

\textcolor{black}{\large \textsc{GAP excellence award}}
